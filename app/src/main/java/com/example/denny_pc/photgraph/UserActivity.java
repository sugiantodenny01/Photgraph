                    ...
                    query.findInBackground(new FindCallback<ParseUser>() {
                        ...
                        public void done(List<ParseUser> objects, ParseException e) {
                            ...
                            if (e == null && objects.size() > 0) {
                                ...
                                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(UserActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (lastKnownLocation != null) {
                                        ...
                                        if (distanceInMiles<0.01){
                                            ...
                                            infoTextView.setText("Photographer Sudah Sampai");
                                            ...
                                            callUberButton.setText("Call Photographer");
                                            requestActive=false;
                                            driverActive= false;
                                            ...
                                            infoTextView.setText("Your Photographer" + distanceOneDP.toString() + " miles away!");
                ...
                public void done(List<ParseObject> objects, ParseException e) {
                    ...
                    if (e == null) {
                        ...
                        if (objects.size() > 0) {
                            ...
                            requestActive = false;
                            callUberButton.setText("Call An Photographer");
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                callUberButton.setText("Cancel Photographer");
                                requestActive = true;
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                ...
                if (e == null) {
                    ...
                    if (objects.size() > 0) {
                        ...
                        requestActive = true;
                        callUberButton.setText("Cancel Photgrapher");
